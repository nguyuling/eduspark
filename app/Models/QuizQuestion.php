...
class QuizQuestion extends Model
{
    ...
    protected $fillable = ['quiz_id', 'teacher_id', 'question_text', 'points', 'type', 'coding_template', 'coding_full_code', 'coding_language', 'coding_expected_output', 'hidden_line_numbers', 'correct_answer'];
