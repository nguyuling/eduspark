...
<div class="app">
  <!-- Sidebar -->
  <aside class="sidebar">
    <img src="<?php echo e(asset('logo.png')); ?>" alt="EduSpark logo" class="logo">
      ...
      <div class="card">
        ...
        <div class="value">
          <span class="badge-pill" style="background:linear-gradient(90deg,var(--accent),var(--accent-2)); padding:8px 12px; border-radius:999px;">
            <?php echo e(\App\Models\Lesson::count()); ?>
...
<?php /**PATH /Users/nguyuling/Downloads/eduspark/resources/views/lessons.blade.php ENDPATH**/ ?>