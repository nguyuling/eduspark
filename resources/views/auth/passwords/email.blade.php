...
<body class="light">
  ...
  <div class="container">
    ...
    <p class="subtitle">Masukkan alamat email anda dan kami akan menghantar pautan untuk tetapkan semula kata laluan.</p>
    ...
    <form method="POST" action="{{ route('password.email') }}">
        ...
        <div class="form-group">
            ...
            <input type="email" id="email" name="email" required placeholder="anda@contoh.com" value="{{ old('email') }}" autofocus>
        </div>

        <button type="submit" class="btn-submit">📧 Hantar Pautan Tetapkan Semula</button>
    </form>
