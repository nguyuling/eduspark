...
.card:hover { transform:translateY(-8px) scale(1.02); box-shadow:0 20px 40px rgba(8,12,20,0.2); }
...
/* Chart panel header */
.panel { border-radius:var(--card-radius); padding:20px; animation: fadeInUp .4s ease; margin-bottom:20px; background: transparent; border: 2px solid #d4c5f9; backdrop-filter: blur(6px); box-shadow: 0 2px 12px rgba(2,6,23,0.18); transition: border-color .2s ease; margin-left:40px; margin-right:40px; }
...
.main-header { display:flex;justify-content:space-between;align-items:flex-start; margin-bottom:20px; margin-top:40px; margin-left:40px; margin-right:40px; }
