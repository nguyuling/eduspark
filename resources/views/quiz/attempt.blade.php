  ...
  <main class="main">
    ...
    <div id="question-navigation-wrapper" style="display:none; margin-top:40px; margin-bottom:30px;">
      <div style="text-align:center;">
        ...
        <div id="question-navigation" style="display:flex; flex-wrap:wrap; gap:8px; justify-content:center; padding:16px; background:rgba(106,77,247,0.05); border-radius:12px; border:1px solid rgba(106,77,247,0.2);">
